<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    $query2 = mysqli_query($config, "SELECT arsiparis, nama, status, alamat, logo FROM tbl_perusahaan");
                    list($arsiparis, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        echo '<img class="logodisp" src="./upload/'.$logo.'"/>';
                        echo '<h6 class="up">'.$arsiparis.'</h6>';
            ...
            <div id="lead">
                <p>Kepala Pimpinan</p>
                <div style="height: 50px;"></div>';
                $query = mysqli_query($config, "SELECT pimpinan, nip FROM tbl_perusahaan");
