        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['arsiparis'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['status'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['pimpinan'] == "" || $_REQUEST['nip'] == ""
                        ...
                        if(!preg_match("/^[a-zA-Z0-9. -]*$/", $nama)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9. -]*$/", $arsiparis)){
                                $_SESSION['arsiparis'] = 'Form Nama arsiparis hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan minus(-)';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {
...
if($ukuran < 2000000){
    ...
    $query = mysqli_query($config, "SELECT logo FROM tbl_perusahaan");
    ...
    $query = mysqli_query($config, "UPDATE tbl_perusahaan SET arsiparis='$arsiparis',nama='$nama',status='$status',alamat='$alamat',pimpinan='$pimpinan',nip='$nip',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_perusahaan='$id_perusahaan'");
    ...
    $query = mysqli_query($config, "UPDATE tbl_perusahaan SET arsiparis='$arsiparis',nama='$nama',status='$status',alamat='$alamat',pimpinan='$pimpinan',nip='$nip',website='$website',email='$email',id_user='$id_user' WHERE id_perusahaan='$id_perusahaan'");
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="input-field col s6">
                                        <input type="hidden" value="<?php echo $id_perusahaan; ?>" name="id_perusahaan">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="arsiparis" type="text" class="validate" name="arsiparis" value="<?php echo $row['arsiparis']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['arsiparis'])){
                                                    $arsiparis = $_SESSION['arsiparis'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$arsiparis.'</div>';
                                                    unset($_SESSION['arsiparis']);
                                                }
                                            ?>
                                        <label for="arsiparis">Manager Arsiparis</label>
                                    </div>
                                    <div class="input-field col s6">
